...
class QMC_Info
{
	...
	void init(int L, int nsites, double tempKelvin, bool measure_corrs)
	{
		...
		this->tempKelvin=tempKelvin;
        	this->temp=tempKelvin*0.0861733;
		this->beta=1.0/temp;
...
{	
	...
	for (int nqx=0;nqx<onedq;nqx++)
	{
		for (int nqy=0;nqy<onedq;nqy++)
		{
			...
			{
				std::vector<double> qvec;
				if (abs(qs[nqx]-qs[nqy])<1.0e-5) //for hhl
				//if (abs(qs[nqz])<1.0e-5)	
				{	
					qvec.push_back(qs[nqx]);
					qvec.push_back(qs[nqy]);
					qvec.push_back(qs[nqz]);
		 ...
		 RMatrix &Jnmat23, RMatrix &Jnmat32)
{
	...
	Jnmat01(0,0)=a; Jnmat01(0,1)=-a; Jnmat01(0,2)=-a;
	Jnmat01(1,0)=a; Jnmat01(1,1)=-a; Jnmat01(1,2)=-a;
	Jnmat01(2,0)=a; Jnmat01(2,1)=-a; Jnmat01(2,2)=-a;
	
	Jnmat10(0,0)=a;  Jnmat10(0,1)=a; Jnmat10(0,2)=a;
	Jnmat10(1,0)=-a;  Jnmat10(1,1)=-a; Jnmat10(1,2)=-a;
	Jnmat10(2,0)=-a;  Jnmat10(2,1)=-a; Jnmat10(2,2)=-a;

	Jnmat02(0,0)=-a; Jnmat02(0,1)=a; Jnmat02(0,2)=-a;
	Jnmat02(1,0)=-a; Jnmat02(1,1)=a; Jnmat02(1,2)=-a;
	Jnmat02(2,0)=-a; Jnmat02(2,1)=a; Jnmat02(2,2)=-a;

	Jnmat20(0,0)=-a;  Jnmat20(0,1)=-a; Jnmat20(0,2)=-a;
	Jnmat20(1,0)=a;  Jnmat20(1,1)=a; Jnmat20(1,2)=a;
	Jnmat20(2,0)=-a;  Jnmat20(2,1)=-a; Jnmat20(2,2)=-a;

	Jnmat03(0,0)=-a; Jnmat03(0,1)=-a; Jnmat03(0,2)=a;
	Jnmat03(1,0)=-a; Jnmat03(1,1)=-a; Jnmat03(1,2)=a;
	Jnmat03(2,0)=-a; Jnmat03(2,1)=-a; Jnmat03(2,2)=a;
	
        Jnmat30(0,0)=-a;  Jnmat30(0,1)=-a; Jnmat30(0,2)=-a;
	Jnmat30(1,0)=-a;  Jnmat30(1,1)=-a; Jnmat30(1,2)=-a;
	Jnmat30(2,0)=a;  Jnmat30(2,1)=a; Jnmat30(2,2)=a;

	Jnmat12(0,0)=-a; Jnmat12(0,1)=a; Jnmat12(0,2)=-a;
	Jnmat12(1,0)=a; Jnmat12(1,1)=-a; Jnmat12(1,2)=a;
	Jnmat12(2,0)=a; Jnmat12(2,1)=-a; Jnmat12(2,2)=a;
	
        Jnmat21(0,0)=-a;  Jnmat21(0,1)=a; Jnmat21(0,2)=a;
	Jnmat21(1,0)=a;  Jnmat21(1,1)=-a; Jnmat21(1,2)=-a;
	Jnmat21(2,0)=-a;  Jnmat21(2,1)=a; Jnmat21(2,2)=a;

	Jnmat13(0,0)=-a; Jnmat13(0,1)=-a; Jnmat13(0,2)=a;
	Jnmat13(1,0)=a; Jnmat13(1,1)=a; Jnmat13(1,2)=-a;
	Jnmat13(2,0)=a; Jnmat13(2,1)=a; Jnmat13(2,2)=-a;

	Jnmat31(0,0)=-a;  Jnmat31(0,1)=a; Jnmat31(0,2)=a;
	Jnmat31(1,0)=-a;  Jnmat31(1,1)=a; Jnmat31(1,2)=a;
	Jnmat31(2,0)=a;  Jnmat31(2,1)=-a; Jnmat31(2,2)=-a;

	Jnmat23(0,0)=a; Jnmat23(0,1)=a; Jnmat23(0,2)=-a;
	Jnmat23(1,0)=-a; Jnmat23(1,1)=-a; Jnmat23(1,2)=a;
	Jnmat23(2,0)=a; Jnmat23(2,1)=a; Jnmat23(2,2)=-a;
	
	Jnmat32(0,0)=a;  Jnmat32(0,1)=-a; Jnmat32(0,2)=a;
	Jnmat32(1,0)=a;  Jnmat32(1,1)=-a; Jnmat32(1,2)=a;
	Jnmat32(2,0)=-a;  Jnmat32(2,1)=a; Jnmat32(2,2)=-a;
}*/
