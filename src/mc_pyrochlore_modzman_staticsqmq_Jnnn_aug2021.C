...
void make_qs(int L, std::vector<std::vector<double> > &qvals)
{
        ...
        for (int nqx=0;nqx<onedq;nqx++)
        {
                for (int nqy=0;nqy<onedq;nqy++)
                {
                        ...
                        {
                                std::vector<double> qvec;
                                if(abs(qs[nqx]-qs[nqy])<1.0e-5)  // Save only hhl
				//if(abs(qs[nqz])<1.0e-5)		// Save only hk0	
                                {
                                        qvec.push_back(qs[nqx]);
                                        qvec.push_back(qs[nqy]);
                                        qvec.push_back(qs[nqz]);
        ...
        cout<<"Number of q points = "<<qvals.size()<<endl;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void make_Jn_mats(double Jnnn, double gxy, double gz,
		 ...
		 RMatrix &Jnmat23, RMatrix &Jnmat32)
{
	...
	double Jn1=Jnnn/6.0*(2.0*gxy*gxy-sqrt(2.0)*gxy*gz-2.0*gz*gz);
	double Jn2=Jnnn/6.0*(gxy*gxy-2.0*sqrt(2.0)*gxy*gz+2.0*gz*gz);
	double Jn3=Jnnn/6.0*2.0*(2.0*gxy*gxy+2.0*sqrt(2.0)*gxy*gz+gz*gz);

	Jnmat01(0,0)=-Jn1; Jnmat01(0,1)=-Jn3; Jnmat01(0,2)=Jn1;
	Jnmat01(1,0)=Jn2; Jnmat01(1,1)=Jn1; Jnmat01(1,2)=-Jn2;
	Jnmat01(2,0)=Jn2; Jnmat01(2,1)=Jn1; Jnmat01(2,2)=-Jn2;
	
	Jnmat10(0,0)=-Jn1;  Jnmat10(0,1)=Jn2; Jnmat10(0,2)=Jn2;
	Jnmat10(1,0)=-Jn3;  Jnmat10(1,1)=Jn1; Jnmat10(1,2)=Jn1;
	Jnmat10(2,0)=Jn1;  Jnmat10(2,1)=-Jn2; Jnmat10(2,2)=-Jn2;

	Jnmat02(0,0)=Jn1; Jnmat02(0,1)=-Jn1; Jnmat02(0,2)=-Jn3;
	Jnmat02(1,0)=-Jn2; Jnmat02(1,1)=Jn2; Jnmat02(1,2)=Jn1;
	Jnmat02(2,0)=-Jn2; Jnmat02(2,1)=Jn2; Jnmat02(2,2)=Jn1;

	Jnmat20(0,0)=Jn1;  Jnmat20(0,1)=-Jn2; Jnmat20(0,2)=-Jn2;
	Jnmat20(1,0)=-Jn1;  Jnmat20(1,1)=Jn2; Jnmat20(1,2)=Jn2;
	Jnmat20(2,0)=-Jn3;  Jnmat20(2,1)=Jn1; Jnmat20(2,2)=Jn1;

	Jnmat03(0,0)=Jn1; Jnmat03(0,1)=Jn1; Jnmat03(0,2)=Jn3;
	Jnmat03(1,0)=-Jn2; Jnmat03(1,1)=-Jn2; Jnmat03(1,2)=-Jn1;
	Jnmat03(2,0)=-Jn2; Jnmat03(2,1)=-Jn2; Jnmat03(2,2)=-Jn1;
	
        Jnmat30(0,0)=Jn1;  Jnmat30(0,1)=-Jn2; Jnmat30(0,2)=-Jn2;
	Jnmat30(1,0)=Jn1;  Jnmat30(1,1)=-Jn2; Jnmat30(1,2)=-Jn2;
	Jnmat30(2,0)=Jn3;  Jnmat30(2,1)=-Jn1; Jnmat30(2,2)=-Jn1;

	Jnmat12(0,0)=-Jn2; Jnmat12(0,1)=Jn2; Jnmat12(0,2)=Jn1;
	Jnmat12(1,0)=-Jn1; Jnmat12(1,1)=Jn1; Jnmat12(1,2)=Jn3;
	Jnmat12(2,0)=Jn2; Jnmat12(2,1)=-Jn2; Jnmat12(2,2)=-Jn1;
	
        Jnmat21(0,0)=-Jn2;  Jnmat21(0,1)=-Jn1; Jnmat21(0,2)=Jn2;
	Jnmat21(1,0)=Jn2;  Jnmat21(1,1)=Jn1; Jnmat21(1,2)=-Jn2;
	Jnmat21(2,0)=Jn1;  Jnmat21(2,1)=Jn3; Jnmat21(2,2)=-Jn1;

	Jnmat13(0,0)=-Jn2; Jnmat13(0,1)=-Jn2; Jnmat13(0,2)=-Jn1;
	Jnmat13(1,0)=-Jn1; Jnmat13(1,1)=-Jn1; Jnmat13(1,2)=-Jn3;
	Jnmat13(2,0)=Jn2; Jnmat13(2,1)=Jn2; Jnmat13(2,2)=Jn1;

	Jnmat31(0,0)=-Jn2;  Jnmat31(0,1)=-Jn1; Jnmat31(0,2)=Jn2;
	Jnmat31(1,0)=-Jn2;  Jnmat31(1,1)=-Jn1; Jnmat31(1,2)=Jn2;
	Jnmat31(2,0)=-Jn1;  Jnmat31(2,1)=-Jn3; Jnmat31(2,2)=Jn1;

	Jnmat23(0,0)=Jn2; Jnmat23(0,1)=Jn2; Jnmat23(0,2)=Jn1;
	Jnmat23(1,0)=-Jn2; Jnmat23(1,1)=-Jn2; Jnmat23(1,2)=-Jn1;
	Jnmat23(2,0)=-Jn1; Jnmat23(2,1)=-Jn1; Jnmat23(2,2)=-Jn3;
	
	Jnmat32(0,0)=Jn2;  Jnmat32(0,1)=-Jn2; Jnmat32(0,2)=-Jn1;
	Jnmat32(1,0)=Jn2;  Jnmat32(1,1)=-Jn2; Jnmat32(1,2)=-Jn1;
	Jnmat32(2,0)=Jn1;  Jnmat32(2,1)=-Jn1; Jnmat32(2,2)=-Jn3;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void make_R_mats(RMatrix &R0, RMatrix &R1, RMatrix &R2, RMatrix &R3)
{
        ...
        double gp=sqrt(1.0/3.0);
        double gm=sqrt(1.0/2.0);
        
	R0(0,0)=2.0*gp*gm;R0(0,1)=-gp*gm;R0(0,2)=-gp*gm;
        R0(1,0)=0.0;R0(1,1)=gm;R0(1,2)=-gm;
        R0(2,0)=gp;R0(2,1)=gp;R0(2,2)=gp;

        R1(0,0)=-gp*gm;R1(0,1)=-2.0*gp*gm;R1(0,2)=gp*gm;
        R1(1,0)=-gm;R1(1,1)=0.0;R1(1,2)=-gm;
        R1(2,0)=gp;R1(2,1)=-gp;R1(2,2)=-gp;

        R2(0,0)=gp*gm;R2(0,1)=-gp*gm;R2(0,2)=-2.0*gp*gm;
        R2(1,0)=-gm;R2(1,1)=-gm;R2(1,2)=0.0;
        R2(2,0)=-gp;R2(2,1)=gp;R2(2,2)=-gp;

        R3(0,0)=gm*gp;R3(0,1)=gm*gp;R3(0,2)=2.0*gm*gp;
        R3(1,0)=-gm;R3(1,1)=gm;R3(1,2)=0.;
        R3(2,0)=-gp;R3(2,1)=-gp;R3(2,2)=gp;
}
		      ...
		      double &eff_field_z)
{
	...
	for (int j=0;j<nneighbors[site].size();j++)
	{
		int k=nneighbors[site][j];
		int t2=ijkt[k][3];
		if (t==0 and t2==1) Jnmat=Jnmat01;
		if (t==1 and t2==0) Jnmat=Jnmat10;
		if (t==0 and t2==2) Jnmat=Jnmat02;
		if (t==2 and t2==0) Jnmat=Jnmat20;
		if (t==0 and t2==3) Jnmat=Jnmat03;
		if (t==3 and t2==0) Jnmat=Jnmat30;
		if (t==1 and t2==2) Jnmat=Jnmat12;
		if (t==2 and t2==1) Jnmat=Jnmat21;
		if (t==1 and t2==3) Jnmat=Jnmat13;
		if (t==3 and t2==1) Jnmat=Jnmat31;
		if (t==2 and t2==3) Jnmat=Jnmat23;
		if (t==3 and t2==2) Jnmat=Jnmat32;
		eff_field_x+=(Jnmat(0,0)*configx[k])+(Jnmat(0,1)*configy[k])+(Jnmat(0,2)*configz[k]);
		eff_field_y+=(Jnmat(1,0)*configx[k])+(Jnmat(1,1)*configy[k])+(Jnmat(1,2)*configz[k]);
		eff_field_z+=(Jnmat(2,0)*configx[k])+(Jnmat(2,1)*configy[k])+(Jnmat(2,2)*configz[k]);
	}
}
		        ...
		        std::vector< std::vector<int> > & ijkt)
{
	...
	for (int i=0;i<nneighbors.size();i++)
	{
		...
		for (int j=0;j<neighbors[i].size();j++)
		{
			...
			int t2=ijkt[k][3];
			vecr(0,0)=configx[k];vecr(1,0)=configy[k];vecr(2,0)=configz[k];
			if (t1==0 and t2==1) Jnmat=Jnmat01;
			if (t1==1 and t2==0) Jnmat=Jnmat10; 
			if (t1==0 and t2==2) Jnmat=Jnmat02; 
			if (t1==2 and t2==0) Jnmat=Jnmat20;
			if (t1==0 and t2==3) Jnmat=Jnmat03;
			if (t1==3 and t2==0) Jnmat=Jnmat30;
			if (t1==1 and t2==2) Jnmat=Jnmat12;
			if (t1==2 and t2==1) Jnmat=Jnmat21;
			if (t1==1 and t2==3) Jnmat=Jnmat13;
			if (t1==3 and t2==1) Jnmat=Jnmat31;
			if (t1==2 and t2==3) Jnmat=Jnmat23;
			if (t1==3 and t2==2) Jnmat=Jnmat32;
			e+=(yt_A_x(vecl,Jnmat,vecr));
		}
	}
...
std::vector<double> eff_h_field(int &t,
                                double &hx,double &hy,double &hz,
                                std::vector<RMatrix> &gmats)
{
        double mu_b=5.7883818012*0.01; // mev/T
        std::vector<double> heff;
        double fieldx,fieldy,fieldz;

        fieldx=-mu_b*(hx*gmats[t](0,0)+hy*gmats[t](1,0)+hz*gmats[t](2,0));

        fieldy=-mu_b*(hx*gmats[t](0,1)+hy*gmats[t](1,1)+hz*gmats[t](2,1));

        fieldz=-mu_b*(hx*gmats[t](0,2)+hy*gmats[t](1,2)+hz*gmats[t](2,2));

        heff.push_back(fieldx);
        heff.push_back(fieldy);
        heff.push_back(fieldz);
		   ...
		   double gxy, double gz) 
{
	...
	time (&start);	
	//////////////////////////////////////
	std::vector<complex<double> > sxq,syq,szq,sxxq,syyq,szzq,sxzq,sxyq,syxq,syzq,szxq,szyq,sperpq;
	std::vector<complex<double> > sxxqavg,syyqavg,szzqavg,sxzqavg,sxyqavg,syxqavg,syzqavg,szxqavg,szyqavg;
	
	std::vector<complex<double> > mxq,myq,mzq,mxxq,myyq,mzzq,mxzq,mxyq,myxq,myzq,mzxq,mzyq,mperpq;
	std::vector<complex<double> > mxxqavg,myyqavg,mzzqavg,mxzqavg,mxyqavg,myxqavg,myzqavg,mzxqavg,mzyqavg;
	/////////////////////////////////////
	...
	sxq.resize(numqs);syq.resize(numqs);szq.resize(numqs);
	sxxq.resize(numqs);sxyq.resize(numqs);sxzq.resize(numqs);
	syxq.resize(numqs);syyq.resize(numqs);syzq.resize(numqs);
	szxq.resize(numqs);szyq.resize(numqs);szzq.resize(numqs);
	sperpq.resize(numqs);

	sxxqavg.resize(numqs);sxyqavg.resize(numqs);sxzqavg.resize(numqs);
	syxqavg.resize(numqs);syyqavg.resize(numqs);syzqavg.resize(numqs);
	szxqavg.resize(numqs);szyqavg.resize(numqs);szzqavg.resize(numqs);
        
	mxq.resize(numqs);myq.resize(numqs);mzq.resize(numqs);
        mxxq.resize(numqs);mxyq.resize(numqs);mxzq.resize(numqs);
        myxq.resize(numqs);myyq.resize(numqs);myzq.resize(numqs);
        mzxq.resize(numqs);mzyq.resize(numqs);mzzq.resize(numqs);
        mperpq.resize(numqs);

        mxxqavg.resize(numqs);mxyqavg.resize(numqs);mxzqavg.resize(numqs);
        myxqavg.resize(numqs);myyqavg.resize(numqs);myzqavg.resize(numqs);
        mzxqavg.resize(numqs);mzyqavg.resize(numqs);mzzqavg.resize(numqs);
	int mcnorm=0;
	double sxxi0=0.0; double sxxij0=0.0; 
	cout<<"before initialized everything "<<numqs<<endl;
	...
	{	
		...
		for (int64_t n=0; n<(nsamples+nburn);n++) // Begin MC
		{
			...
			double local_energyj2=( (sxnew*eff_field_x) + (synew*eff_field_y)+ (sznew*eff_field_z))*spin*spin;
		        double local_energyh1=local_h_energy(spin,site,t,sx,sy,sz,hx,hy,hz,gmats);
                        double local_energyh2=local_h_energy(spin,site,t,sxnew,synew,sznew,hx,hy,hz,gmats);
			...
			else
			{
				...
				// Still move spin if rejected, but this conserves energy!!i
				// modified from here to include h
				std::vector<double> heff=eff_h_field(t,hx,hy,hz,gmats);
                                eff_field_x=eff_field_x*spin+heff[0];eff_field_y=eff_field_y*spin+heff[1];
                                eff_field_z=eff_field_z*spin+heff[2];
				// modified till here to include h
			...
			if (n>nburn and n%nsites==0)
			{
				//int numqs=qvals.size();
				
				//the variables sxxq, sxyq ... etc represents spin-spin correlations in the local basis and the 
				//variables sxq syq szq represents the fourier transform in the local basis

				fourier_transforms(spin,ijkt,Rmats,phases,infos[b].configx,infos[b].configy,infos[b].configz,sxq,syq,szq);
				//the variables sxxq, sxyq ... etc represents spin-spin correlations in the local basis
				mcnorm=mcnorm+1;
				//cout<<n<<endl;
				//the variables sxxq, sxyq ... etc represents spin-spin correlations in the local basis
	   			for (int nq=0;nq<numqs;nq++) 
	      			{
					sxxq[nq]+=sxq[nq]*conj(sxq[nq])/double(nsites);
					sxyq[nq]+=sxq[nq]*conj(syq[nq])/double(nsites);
					sxzq[nq]+=sxq[nq]*conj(szq[nq])/double(nsites);

					syxq[nq]+=syq[nq]*conj(sxq[nq])/double(nsites);
					syyq[nq]+=syq[nq]*conj(syq[nq])/double(nsites);
					syzq[nq]+=syq[nq]*conj(szq[nq])/double(nsites);

					szxq[nq]+=szq[nq]*conj(sxq[nq])/double(nsites);
					szyq[nq]+=szq[nq]*conj(syq[nq])/double(nsites);
					szzq[nq]+=szq[nq]*conj(szq[nq])/double(nsites);
				}
				// the variables mxq,myq,mzq represent the fourier transformation of g*s in the global basis and 
				// the variables mxxq, myyq etc are the moment moment correlations 
				fourier_transforms(spin,ijkt,gmats,phases,infos[b].configx,infos[b].configy,infos[b].configz,mxq,myq,mzq);
			        for (int nq=0;nq<numqs;nq++)
                                {
                                        mxxq[nq]+=mxq[nq]*conj(mxq[nq])/double(nsites);
                                        mxyq[nq]+=mxq[nq]*conj(myq[nq])/double(nsites);
                                        mxzq[nq]+=mxq[nq]*conj(mzq[nq])/double(nsites);

                                        myxq[nq]+=myq[nq]*conj(mxq[nq])/double(nsites);
                                        myyq[nq]+=myq[nq]*conj(myq[nq])/double(nsites);
                                        myzq[nq]+=myq[nq]*conj(mzq[nq])/double(nsites);

                                        mzxq[nq]+=mzq[nq]*conj(mxq[nq])/double(nsites);
                                        mzyq[nq]+=mzq[nq]*conj(myq[nq])/double(nsites);
                                        mzzq[nq]+=mzq[nq]*conj(mzq[nq])/double(nsites);
                                }

				/*for(int i=0;i<nsites;i++)
				{
					int tp=ijkt[i][3];
					double mxi=gmats[tp](0,0)*infos[b].configx[i]+gmats[tp](0,1)*infos[b].configy[i]+									 gmats[tp](0,2)*infos[b].configz[i];
					for (int j=i;j<nsites;j++)
					{		
					int tpp=ijkt[j][3];	
					double mxj=gmats[tpp](0,0)*infos[b].configx[j]+gmats[tpp](0,1)*infos[b].configy[j]+									 gmats[tpp](0,2)*infos[b].configz[j];
						
						//if (i==j) sxxi0+=infos[b].configx[i]*infos[b].configy[j] ;
						if (i==j) sxxi0+=mxi*mxj ;
						if (i!=j) sxxij0+=mxi*mxj ;
						//if (i!=j) sxxij0+=infos[b].configx[i]*infos[b].configy[j] ;
					}
				}*/
			}
		...
		/*time_evolve(spin, deltat, tottime, L, infos[0].configx,infos[0].configy,infos[0].configz,neighbors, 
		      nneighbors, Jmat01, Jmat10, Jmat02, Jmat20, Jmat03, Jmat30, Jmat12, Jmat21, Jmat13, Jmat31, Jmat23, Jmat32, Jnmat01, Jnmat10, Jnmat02, Jnmat20, Jnmat03, Jnmat30, Jnmat12, Jnmat21, Jnmat13, Jnmat31, Jnmat23, Jnmat32, Jnnn, bond_disorder_matrix, gmats, fullcoords, ijkt, qvals, phases, omegas, smunu);
	...
	for (int nq=0;nq<numqs;nq++)
                     {
                      ...
                      sxxqavg[nq]=sxxq[nq]/double(mcnorm);
		      sxyqavg[nq]=sxyq[nq]/double(mcnorm);
                      sxzqavg[nq]=sxzq[nq]/double(mcnorm);

                      syxqavg[nq]=syxq[nq]/double(mcnorm);
                      syyqavg[nq]=syyq[nq]/double(mcnorm);
                      syzqavg[nq]=syzq[nq]/double(mcnorm);

                      szxqavg[nq]=szxq[nq]/double(mcnorm);
                      szyqavg[nq]=szyq[nq]/double(mcnorm);
                      szzqavg[nq]=szzq[nq]/double(mcnorm);
		     
		      mxxqavg[nq]=mxxq[nq]/double(mcnorm);
                      mxyqavg[nq]=mxyq[nq]/double(mcnorm);
                      mxzqavg[nq]=mxzq[nq]/double(mcnorm);

                      myxqavg[nq]=myxq[nq]/double(mcnorm);
                      myyqavg[nq]=myyq[nq]/double(mcnorm);
                      myzqavg[nq]=myzq[nq]/double(mcnorm);

                      mzxqavg[nq]=mzxq[nq]/double(mcnorm);
                      mzyqavg[nq]=mzyq[nq]/double(mcnorm);
                      mzzqavg[nq]=mzzq[nq]/double(mcnorm);

                     }
	sxxi0=sxxi0/double(mcnorm)/double(nsites);
	sxxij0=2.0*sxxij0/double(mcnorm)/double(nsites);
	        ofstream f; ofstream f1;
                stringstream ss,ss1;
                double mil=nsamples/1000000.0;	
                int npart=int(L*L*L*16/1000);
		double h_mod=sqrt(hx*hx+hy*hy+hz*hz);
		//ss1<<"param2m_hhl_"<<Jnnn<<"Jnnng_"<<tempKelvin<<"T_"<<npart<<"kpart_"<<mil<<"mil.dat";
		ss1<<"param2m_hhl_"<<Jnnn<<"Jnnng_"<<h_mod<<"h111_"<<tempKelvin<<"T_"<<npart<<"kpart_"<<mil<<"mil.dat";
		ss<<"param2localSq_hhl"<<Jnnn<<"Jnnng_"<<h_mod<<"h111_"<<tempKelvin<<"T_"<<npart<<"kpart_"<<mil<<"mil.dat";
	        f.open(ss.str(),ios::app);
	        f1.open(ss1.str(),ios::app);
		//f<<"sxxi="<<sxxi0<<"	"<<"sxxij="<<sxxij0<<"	"<<"sxx(0)="<<sxxi0+sxxij0<<endl;
		cout<<"======================================================================================================================================="<<endl;
		cout<<"======================================================================================================================================="<<endl;
		...
		for (int i=0;i<numqs;i++)
		{
			...
			complex<double> sxx=sxxqavg[i];complex<double> syy=syyqavg[i];complex<double> szz=szzqavg[i];
			complex<double> sxy=sxyqavg[i];complex<double> syx=syxqavg[i];
			complex<double> sxz=sxzqavg[i];complex<double> szx=szxqavg[i];
			complex<double> syz=syzqavg[i];complex<double> szy=szyqavg[i];
			
			complex<double> mxx=mxxqavg[i];complex<double> myy=myyqavg[i];complex<double> mzz=mzzqavg[i];
                        complex<double> mxy=mxyqavg[i];complex<double> myx=myxqavg[i];
                        complex<double> mxz=mxzqavg[i];complex<double> mzx=mzxqavg[i];
                        complex<double> myz=myzqavg[i];complex<double> mzy=mzyqavg[i];

			//complex<double> sperp;
		        double q2=((qx*qx)+(qy*qy)+(qz*qz));
			complex<double> sperp=0.0,mperp=0.0;
			if (abs(q2)>1.0e-6)
			{
			...
			f<<boost::format("%+ .5f  %+ .5f  %+ .5f  %+ .8f   %+ .8f   %+ .8f   %+ .8f   %+ .8f   %+ .8f  %+ .8f  %+ .8f %+ .8f  %+ .8f") %qx %qy %qz %sxx %sxy %sxz %syx %syy %syz %szx %szy %szz %sperp<<endl;
		        
			if (abs(q2)>1.0e-6)
                        {
                                mperp=(1.0 - (qx*qx/q2))*mxx + (1.0 - (qy*qy/q2))*myy + (1.0 - (qz*qz/q2))*mzz + (-mxy*qx*qy/q2) + (-myx*qy*qx/q2) + (-mxz*qx*qz/q2) + (-mzx*qx*qz/q2) + (-myz*qz*qy/q2) + (-mzy*qz*qy/q2);
                        }
                        else
                        {
                                mperp=mxx + myy + mzz;
                        }
                        f1<<boost::format("%+ .5f  %+ .5f  %+ .5f  %+ .8f   %+ .8f   %+ .8f   %+ .8f   %+ .8f   %+ .8f  %+ .8f  %+ .8f %+ .8f  %+ .8f") %qx %qy %qz %mxx %mxy %mxz %myx %myy %myz %mzx %mzy %mzz %mperp<<endl;
