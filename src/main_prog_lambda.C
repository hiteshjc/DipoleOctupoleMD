...
int main(int argc, char *argv[])
{
    ...
    double Jx=0.0385; double Jy=0.088; double Jz=0.02; double Jxz=0.0;
    double a=J1;
    J1=a/6.0*(-2.0*Jx+sqrt(2.0)*Jxz+2.0*Jz);
    J2=a/3.0*(-2.0*Jx-2.0*sqrt(2.0)*Jxz-Jz);
    J3=1/6.0*(a*Jx-a*2.0*sqrt(2.0)*Jxz-3.0*Jy+a*2.0*Jz);
    J4=1/6.0*(-a*Jx+a*2.0*sqrt(2.0)*Jxz-3.0*Jy-a*2.0*Jz);
    if (nreplicas==1)
    {   // serial MC 
